...
//        properties.put("mail.debug", "true");
    ...
    public static void sendEmail(){
        ...
        String mailTo = "neo.jd@neolab.net";
        ...
        for (Map.Entry<String, Integer> entrySet : JsoupCrawler.HttpErrorMap.entrySet()) {
            message += "<p>" + entrySet.getKey() + " : " + entrySet.getValue() + "\r" + "" + "</p>";
        }
